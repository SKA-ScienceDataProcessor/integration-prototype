#!/usr/bin/env python3
"""
An example of logging server which uses socketserver module, taken from
...
class LogRecordSocketReceiver(socketserver.ThreadingTCPServer):
    ...
    def __init__(self, host=os.environ['SIP_HOSTNAME'],
...
def main():
    ...
    print('About to start TCP server on ' + os.environ['SIP_HOSTNAME'] + '...')
    try:
