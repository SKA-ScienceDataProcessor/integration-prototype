...
from db_client import MasterDbClient
...
def test_set_sdp_state():
    ...
    mc_key = mc_list[0]
    assert mc_key == key
    db_client.update_sdp_state(sdp_field, value)
    events = mc_event_queue.get_published_events()
