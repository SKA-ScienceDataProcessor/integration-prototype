...
class TestDocker(unittest.TestCase):
    ...
    def testTask(self):
        ...
        t = paas.run_task('test_task_1', 'sip', [],
                ['python3', 'sip/common/tests/mock_task.py', '10', '0'])
    ...
    def testService(self):
        ...
        t = paas.run_service('test_service', 'sip', [9999],
                ['python3', 'sip/common/tests/mock_service.py', '9999'])
    ...
    def testStop(self):
        ...
        t = paas.run_task('test_stop', 'sip', [],
                ['python3', 'sip/common/tests/mock_task.py', '30', '0'])
    ...
    def testFind(self):
        ...
        t1 = paas.run_task('test_find', 'sip', [],
                ['python3', 'sip/common/tests/mock_task.py', '0', '0'])
