""" Slave configuration and status
The slave_config dictionary defines the properties of all the slave controllers 
that we might want to start. It is indexed by the slave 'name' (just some
...
The slave_status dictionary contains:
